...
class StartupDialog(ManagedToplevel):
    ...
    def __init__(self, parent, on_ready=None):
        self.window_title = tr("startup.window_title", "CTkMaker")
    ...
    def _build_header(self, parent) -> None:
        ...
        ctk.CTkLabel(
            title_row, text=tr("startup.title", "CTkMaker"),
        ...
        ctk.CTkLabel(
            header,
            text=tr("startup.subtitle", "Open a recent project or create a new one"),
            font=ui_font(11),
    ...
    def _build_recent_buttons(self) -> None:
        ...
        ctk.CTkButton(
            btn_row, text=tr("startup.browse", "Browse..."), height=28, corner_radius=4,
        ...
        self._open_btn = ctk.CTkButton(
            btn_row, text=tr("startup.open", "Open"), height=28, corner_radius=4,
            font=ui_font(10),
            state="disabled",
    ...
    def _build_footer(self, parent) -> None:
        ...
        ctk.CTkButton(
            footer, text=tr("startup.create_project", "+ Create Project"), width=160, height=32,
    ...
    def _on_close(self) -> None:
        ...
        # silently quit.
        confirm = ask_yes_no(
            tr("startup.quit_title", "Quit CTkMaker?"),
            tr("startup.quit_msg",
