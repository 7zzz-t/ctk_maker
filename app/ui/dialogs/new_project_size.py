...
class NewProjectSizeDialog(ManagedToplevel):
    ...
    def __init__(
        ...
        self.window_title = tr("new_project.title", "New project")
    ...
    def build_content(self) -> ctk.CTkFrame:
        ...
        ctk.CTkButton(
            footer, text=tr("new_project.create_project", "+ Create Project"), width=160, height=32,
            corner_radius=4, command=self._on_ok,
        ).pack(side="right")
        ctk.CTkButton(
            footer, text=tr("new_project.cancel", "Cancel"), width=90, height=32,
            corner_radius=4,
