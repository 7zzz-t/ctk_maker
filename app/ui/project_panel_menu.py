...
class ProjectPanelMenu:
    ...
    def show_context_menu(
        ...
        if meta is None:
            ...
            panel._menu_command(
                menu, tr("pp.menu.new_page", "New Page..."), "app-window",
                panel._on_new_page,
            )
            panel._menu_command(
                menu, tr("pp.menu.new_folder", "New Folder..."), "folder",
                panel._on_new_folder,
            )
            panel._menu_cascade(
                menu, tr("pp.menu.add", "Add"), "square-plus",
                panel._build_add_submenu(menu),
            )
            menu.add_separator()
            panel._menu_command(
                menu,
                tr("pp.menu.show_assets_in_explorer",
                   "Show assets folder in Explorer"),
            ...
            if kind == "folder":
                ...
                if is_pages_folder:
                    ...
                    panel._menu_command(
                        menu, tr("pp.menu.new_page", "New Page..."),
                        "app-window", panel._on_new_page,
                    )
                    menu.add_separator()
                    panel._menu_command(
                        menu,
                        tr("pp.menu.show_in_explorer", "Show in Explorer"),
                        "folder-open", self.on_context_reveal,
                    )
                else:
                    # Folder right-click — same compact shape:
                    # New Subfolder + Add here ▶ + actions.
                    panel._menu_command(
                        menu, tr("pp.menu.new_subfolder", "New Subfolder..."),
                        "folder", panel._on_new_folder,
                    )
                    panel._menu_cascade(
                        menu, tr("pp.menu.add_here", "Add here"),
                        "square-plus", panel._build_add_submenu(menu),
                    )
                    menu.add_separator()
                    panel._menu_command(
                        menu,
                    ...
                    panel._menu_command(
                        menu, tr("pp.menu.rename", "Rename..."), "pencil",
                        panel._on_rename,
                    )
                    panel._menu_command(
                        menu, tr("pp.menu.delete_folder", "Delete folder..."),
                        "trash-2", panel._on_delete_folder,
                    )
            elif kind == "page":
                ...
                panel._menu_command(
                    menu, tr("pp.menu.switch_to_this_page",
                             "Switch to this page"), "external-link",
                    panel._on_context_switch_page,
                )
                panel._menu_command(
                    menu, tr("pp.menu.duplicate", "Duplicate"), "copy",
                ...
                menu.add_separator()
                panel._menu_command(
                    menu, tr("pp.menu.show_in_explorer", "Show in Explorer"),
                    "folder-open", self.on_context_reveal,
                )
                panel._menu_command(
                    menu, tr("pp.menu.delete_page", "Delete page..."),
                    "trash-2", panel._on_context_delete_page,
                )
            else:
                panel._menu_command(
                    menu, tr("pp.menu.open", "Open"), "external-link",
                    self.on_context_open,
                )
                panel._menu_command(
                    menu, tr("pp.menu.show_in_explorer", "Show in Explorer"),
                    "folder-open", self.on_context_reveal,
                ...
                if kind != "fonts":
                    panel._menu_command(
                        menu, tr("pp.menu.reimport", "Reimport..."),
                        "rotate-cw", self.on_context_reimport,
                    )
                menu.add_separator()
                panel._menu_command(
                    menu, tr("pp.menu.rename", "Rename..."), "pencil",
                ...
                panel._menu_command(
                    menu, tr("pp.menu.remove_from_project",
                             "Remove from project..."), "trash-2",
