...
class ComponentWindowInsertDialog(ManagedToplevel):
    ...
    def __init__(
        ...
        self.window_title = tr("component_insert.title", "Insert Window component")
    ...
    def build_content(self) -> ctk.CTkFrame:
        ...
        ctk.CTkLabel(
            body, text=tr("component_insert.ask_dialog", "Insert as a new Dialog?"),
        ...
        ctk.CTkLabel(
            body,
            text=tr(
                "component_insert.component_desc",
                "\"{name}\" is a Window component.",
            ).format(name=self._component_name),
            font=ui_font(10),
        ...
        ctk.CTkButton(
            footer, text=tr("component_insert.insert", "Insert"), width=120, height=32,
            corner_radius=4, command=self._on_insert,
        ).pack(side="right")
        ctk.CTkButton(
            footer, text=tr("component_insert.cancel", "Cancel"), width=90, height=32,
            corner_radius=4,
