...
class ColorPickerDialog(ctk.CTkToplevel):
    ...
    def __init__(self, master, initial_color: str = "#ffffff",
        ...
        title = title or tr("tint_picker.title", "Color Picker")
        self.title(title)
    ...
    def _build_compare_row(self, parent) -> None:
        ...
        self.eyedrop_btn = ctk.CTkButton(
            row, text=tr("tint_picker.pick", "💧 Pick"),
    ...
    def _build_hex_input(self, parent) -> None:
        ...
        ctk.CTkLabel(row, text=tr("tint_picker.hex", "Hex"),
                     font=("", 10), width=28,
    ...
    def _build_saved_row(self, parent) -> None:
        ...
        ctk.CTkLabel(
            header, text=tr("tint_picker.saved_colors", "SAVED COLORS"),
            font=("", 10, "bold"),
    ...
    def _build_buttons(self, parent) -> None:
        ...
        ctk.CTkButton(
            row, text=tr("tint_picker.ok", "OK"), height=30, corner_radius=8,
            command=self._on_ok,
        ).pack(fill="x")
