...
class Palette(ctk.CTkFrame):
    ...
    def _build_tabs(self) -> None:
        ...
        self._btn_widgets = ctk.CTkButton(
            self._tab_bar, text=tr("palette.tab_widgets", "Widgets"),
        ...
        self._btn_components = ctk.CTkButton(
            self._tab_bar, text=tr("palette.tab_components", "Components"),
    ...
    def _build_widgets_tab(self) -> None:
        ...
        self._filter_entry = ctk.CTkEntry(
            ...
            placeholder_text=tr("palette.filter_placeholder", "Filter"),
            height=24,
            fg_color=FILTER_BG,
    ...
    def _render_group(self, group: WidgetGroup, items: list[WidgetEntry], *,
        ...
        title_lbl = ctk.CTkLabel(
            header, text=tr(f"palette.group.{group.title}", group.title),
    ...
    def _render_item(self, entry: WidgetEntry) -> None:
        ...
        name_lbl = ctk.CTkLabel(
            row, text=tr(f"palette.widget.{entry.display_name}", entry.display_name),
    ...
    def _create_ghost(self, entry: WidgetEntry) -> None:
        ...
        label = tk.Label(
            frame,
            text=tr("palette.drag_add", "+ {name}").format(
                name=tr(
                    f"palette.widget.{entry.display_name}",
                    entry.display_name,
                ),
            ),
