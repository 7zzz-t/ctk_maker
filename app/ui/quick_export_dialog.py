...
class QuickExportDialog(ManagedToplevel):
    ...
    def __init__(
        ...
        self.window_title = tr("quick_export.window_title", "Quick Export")
    ...
    def build_content(self) -> ctk.CTkFrame:
        ...
        ctk.CTkLabel(
            outer, text=tr("quick_export.quick_export_label", "Quick Export"),
        ...
        ctk.CTkLabel(
            head, text=tr("quick_export.exporting_document", "Exporting document:"),
            font=ui_font(10),
            text_color=SUBTITLE_FG, anchor="w",
        ).pack(side="left")
        ctk.CTkLabel(
        ...
        stk.Label(
            out_row, text=tr("quick_export.output_label", "Output:"),
        ...
        ctk.CTkLabel(
            outer, text=tr("quick_export.choose_format", "Choose format:"),
        ...
        for icon, title, blurb in (
            (
                "•",
                tr("quick_export.python_file", "Python file"),
                tr(
                    "quick_export.python_blurb",
            ...
            (
                "•",
                tr("quick_export.zip_archive", "ZIP archive"),
                tr(
                    "quick_export.zip_blurb",
        ...
        ctk.CTkButton(
            footer, text=tr("quick_export.export_zip", "Export as ZIP"),
            width=130, height=30, corner_radius=4,
            fg_color="#3c3c3c", hover_color="#4a4a4a",
            command=lambda: self._pick("zip"),
        ).pack(side="right")
        ctk.CTkButton(
            footer, text=tr("quick_export.export_python", "Export as Python"),
            width=150, height=30, corner_radius=4,
            command=lambda: self._pick("py"),
        ).pack(side="right", padx=(0, 8))
        ctk.CTkButton(
            footer, text=tr("quick_export.cancel", "Cancel"),
